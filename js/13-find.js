...
const findCountryCodeOld = (countryName) => {
  countries.forEach((country) => {
    if (country.name == countryName) {
      console.log("The country code is ", country.code);
      return;
    }
  });
};
...
const findCountryCode = (countryName) => {
  let matchedCountry = countries.find((country) => country.name == countryName); // { }  || null
  //   if (matchedCountry) {
  //     console.log("The country code is ", matchedCountry.code);
  //   }
  //   console.log(
  //     "The country code is ",
  ...
  console.log("The country code is ", matchedCountry?.code.at.ad);
};

findCountryCode("Nepal");
findCountryCode("Dell");
// findCountryCode("Zimbabwe")
// findCountryCode("India")
// findCountryCode("Iran")
