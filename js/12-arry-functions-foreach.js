...
function loginUser(inputemail, inputpassword) {
  let msg = "invalid credentails";

  // for (let index = 0; index < dbUsers.length; index++) {
  //   let { email, password, name } = dbUsers[index];
  //   if (email == inputemail && password == inputpassword) {
  //     msg = `"Login Successful !", ${name}`;
  //     break;
  //   }
  // }
...
console.log(loginUser("urmila@gmail.com", "urmila38"));
console.log(loginUser("yogesh@gmail.com", "yogesh38"));
console.log(loginUser("urmila@gmail.com", "urmila-wrong"));
console.log(loginUser("saroj@gmail.com", "saroj30"));
